...
export function InspirationHeader({
  ...
  return (
    <section className="mb-12">
      ...
      <div className="mt-4 flex w-fit items-center gap-3 rounded-lg border border-safety-cleared-300 bg-safety-cleared-100 px-4 py-2">
        ...
        <span className="text-xs font-medium uppercase tracking-wider text-safety-cleared-800">
          {statusLabel}
        </span>
      </div>
    </section>
