...
export function PlanUpdateDiff({ previous, next, status }: PlanUpdateDiffProps) {
  return (
    <div className="my-6 flex justify-center">
      <div className="flex items-center gap-3 rounded-full border border-dashed border-border bg-[color-mix(in_srgb,var(--surface)_50%,transparent)] px-6 py-3 text-xs">
