...
// Phase 9a — Slice D recipe materialization tests deleted: the
// materializeRecipesForCommit / layer2Materialize / resolveDiscoverCandidate
// paths were removed from PlansService when the planner moved to emitting
// real recipe_ids under PLANNER_PROMPT.
// in the BullMQ job).
